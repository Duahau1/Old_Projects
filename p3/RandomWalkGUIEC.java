...
public class RandomWalkGUIEC {
	 ...
	 * @param gridSize  the size of the grid
	 */
	private static void createGUI(RandomWalkEC walker, int gridSize)
	{
		JFrame frame = new JFrame("RandomWalk GUI");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		GridMapEC panel = new GridMapEC(walker, gridSize);
	...
	public static void main(String[] args)
	{
		...
		RandomWalkEC walker;
		if (seed > 0) {
			walker = new RandomWalkEC(gridSize, seed);
		} else {
			walker = new RandomWalkEC(gridSize);
