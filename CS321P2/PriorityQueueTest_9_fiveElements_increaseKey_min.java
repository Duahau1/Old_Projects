 ...
 * Tests for Change Scenario: 5 elements -> increase priority of min to smaller value
 * 
 * @author CS 321
 */
public class PriorityQueueTest_9_fiveElements_increaseKey_min
{
	...
	// Key of element not in priority queue
