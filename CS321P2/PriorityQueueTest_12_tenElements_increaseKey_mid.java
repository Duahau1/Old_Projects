 ...
 * Tests for Change Scenario: 10 elements -> increase priority of last to middle value
 * 
 * @author CS 321
 */

public class PriorityQueueTest_12_tenElements_increaseKey_mid
{
	...
	// Increase priority value - middle value
	private static final Integer NEW_PRIORITY = TestCase.KEY_E; 
