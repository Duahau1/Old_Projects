...
public class ListTester {
	...
	private final static ListToUse LIST_TO_USE = ListToUse.IUArrayList;
	...
	private void runTests() {
		...
		testTwoElementList(ABC_removefirst_BC,"ABC_removefirst_BC",LIST_BC,STRING_BC);//7
		testTwoElementList(ABC_removeLast_AB,"ABC_removeLast_AB",LIST_AB,STRING_AB);//8
		testTwoElementList(ABC_removeB_AC,"ABC_removeB_AC",LIST_AC,STRING_AC);//8
	...
	/** Scenario 23 :[A,B,C] -> remove(1) -> [A,C] 
